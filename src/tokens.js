...
export const CATEGORIES = ['Hoodie', 'Zip Hoodie', 'Sweatshirt', 'T-Shirt PRF', 'T-Shirt Cot', 'Polo', 'T-Shirt Ws', 'T-Shirt Bsc', 'Short', 'Skirt', 'Sweatpants', 'Jogger', 'Giacca', 'Cap BSC', 'Cap PRF', 'Altro']
